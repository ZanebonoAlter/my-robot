...
func NewFirecrawlScheduler() *FirecrawlScheduler {
	return &FirecrawlScheduler{
		...
		status:        "idle",
		concurrency:   1,
		queue:         content.NewFirecrawlJobQueue(repository.Repo.DB()),
	}
}
...
func (s *FirecrawlScheduler) GetStatus() adminhandler.SchedulerStatusResponse {
	return adminhandler.SchedulerStatusResponse{
