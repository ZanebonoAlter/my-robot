...
var mergeQueueService *service.MergeReembeddingQueueService
var mergeQueueServiceOnce sync.Once

func getMergeReembeddingQueueService() *service.MergeReembeddingQueueService {
	mergeQueueServiceOnce.Do(func() {
		mergeQueueService = service.NewMergeReembeddingQueueService(nil)
	})
