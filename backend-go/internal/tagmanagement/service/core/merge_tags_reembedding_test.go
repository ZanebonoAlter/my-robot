...
func setupMergeReembeddingTestDB(t *testing.T) *gorm.DB {
	...
	if err := db.AutoMigrate(&models.TopicTag{}, &models.TopicTagEmbedding{}, &models.TopicTagRelation{}, &models.EmbeddingConfig{}, &models.MergeReembeddingQueue{}, &models.Article{}, &models.ArticleTopicTag{}, &models.TopicTagSemanticLabel{}, &models.SemanticLabel{}, &models.EmbeddingQueue{}); err != nil {
