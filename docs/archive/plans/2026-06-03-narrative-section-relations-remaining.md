...
> **SUPERSEDED:** The incremental greedy matching algorithm described in this plan (`MatchAndSaveRelations`, `shouldWriteRelation`, `competitiveFilter`, `hasContinuationInIntermediateDays`) has been replaced by Hungarian bipartite matching (`RebuildBoardRelations`). See `docs/archive/plans/2026-06-06-bipartite-relation-matching.md`.
