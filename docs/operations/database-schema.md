<<<<<<< Updated upstream:docs/reference/database/DATABASE_FIELDS.md
# 数据库字段说明文档
...
- `docs/operations/architecture/data-flow.md` - 详细工作流程说明
- `docs/operations/database-operations.md` - 数据库运维与迁移手册
- `AGENTS.md` - 项目开发指南
>>>>>>> Stashed changes:docs/operations/database-schema.md
