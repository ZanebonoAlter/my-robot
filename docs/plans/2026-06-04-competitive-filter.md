...
> **SUPERSEDED:** The `competitiveFilter` and `shouldWriteRelation` functions described here have been replaced by Hungarian bipartite matching (`RebuildBoardRelations`). See `docs/plans/2026-06-06-bipartite-relation-matching.md`.
