<<<<<<< Updated upstream:docs/getting-started.md
# 快速开始
...
端口映射和其他 Docker 设置可通过 `.env` 文件自定义 — 详见 [配置指南](../operations/configuration.md)。
...
- **[配置指南](../operations/configuration.md)** — 完整的环境变量列表、配置文件选项和数据库存储的 AI 设置。
- **[开发指南](../developer/operations.md)** — 构建命令、测试命令、编码规范和提交检查清单。
- **[架构概览](../operations/architecture/overview.md)** — 系统设计、组件关系、数据流和后台调度器详情。
>>>>>>> Stashed changes:docs/user-guide/getting-started.md
