...
> **SUPERSEDED:** This proposal describes the old incremental greedy matching algorithm. It has been replaced by Hungarian bipartite matching (`RebuildBoardRelations`). See `docs/plans/2026-06-06-bipartite-relation-matching.md`.
