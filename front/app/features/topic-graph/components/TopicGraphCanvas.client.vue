...
function tokenColors(): TokenColors {
  ...
  _tokenCache = {
    accent: getCSSVar('--color-accent') || '#d94a4a',
    accentHover: getCSSVar('--color-accent-hover') || '#c12f2f',
    accentSubtle: getCSSVar('--color-accent-subtle') || 'rgba(217,74,74,0.08)',
    bgElevated: getCSSVar('--color-bg-elevated') || '#f5f0e6',
    bgSunken: getCSSVar('--color-bg-sunken') || '#e8dfd1',
    textPrimary: getCSSVar('--color-text-primary') || '#1a1a1a',
    textSecondary: getCSSVar('--color-text-secondary') || '#5a5a5a',
    textMuted: getCSSVar('--color-text-muted') || '#8a8a8a',
    borderSubtle: getCSSVar('--color-border-subtle') || 'rgba(26,26,26,0.08)',
    borderMedium: getCSSVar('--color-border-medium') || 'rgba(26,26,26,0.15)',
