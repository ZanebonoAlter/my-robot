...
### Requirement: 业务约束与执行规范上下文获取（apply 前置）
...
- **WHEN** git diff 含 `backend-go/internal/platform/airouter/router.go` 且 `ai-logging.md` 头 `doc-impact-applies` 含 `internal/platform/airouter/`
