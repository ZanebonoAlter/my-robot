...
TBD: This spec governs the accuracy and maintenance of architecture documentation files (`docs/reference/architecture/*.md`) relative to the actual backend codebase.
