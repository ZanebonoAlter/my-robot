# Tag Match Identity Protection

## Purpose

Prevent tag identity confusion by ensuring high-similarity embedding matches do not automatically merge tags that should remain separate.
